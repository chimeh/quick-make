...
#define HAL_NLM_F_MATCH            0x200        /* Return all entries matching criteria in message content. */
#define HAL_NLM_F_ATOMIC           0x400        /* Atomic snapshot of the table being referenced. */

/* Additional flag bits for NEW requests. */
#define HAL_NLM_F_REPLACE          0x100        /* Replace existing matching config object. */
#define HAL_NLM_F_EXCL             0x200        /* Don't replace the config object if it already exists. */
#define HAL_NLM_F_CREATE           0x400        /* Create config object if it doesn't exist. */
