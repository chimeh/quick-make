...
EXPORT_SYMBOL(bcmx_lport_to_modid);
EXPORT_SYMBOL(bcmx_unit_port_to_lport);
...
EXPORT_SYMBOL(bcmx_lport_valid);
...
//EXPORT_SYMBOL(SOC_IS_EASYRIDER);
EXPORT_SYMBOL(bcmx_lport_flags);
...
EXPORT_SYMBOL(bcmx_uport_create);
...
EXPORT_SYMBOL(bcmx_lport_first);
...
EXPORT_SYMBOL(bcmx_lport_bcm_unit);
...
EXPORT_SYMBOL(bcmx_lport_remove_notify);
...
EXPORT_SYMBOL(bcmx_lport_to_unit_port);
EXPORT_SYMBOL(bcmx_lport_modid);
...
#endif
#endif
/* add by liujia for diag test */
EXPORT_SYMBOL(soc_fb_l3x2_entry_hash);
EXPORT_SYMBOL(soc_reg64_set);
EXPORT_SYMBOL(soc_tr_mpls_base_entry_to_key);
EXPORT_SYMBOL(soc_mem_datamask_memtest);
EXPORT_SYMBOL(_shr_scale_uint64);
EXPORT_SYMBOL(soc_tr_egr_vlan_xlate_base_entry_to_key);
EXPORT_SYMBOL(soc_mem_slamable);
EXPORT_SYMBOL(soc_tr_vlan_xlate_bank_entry_hash);
EXPORT_SYMBOL(soc_fb_l3x_bank_entry_hash);
EXPORT_SYMBOL(_bcm_tr_l2_to_l2x);
#include <soc/triumph2.h>
EXPORT_SYMBOL(soc_triumph2_pipe_mem_clear);
EXPORT_SYMBOL(soc_tr_vlan_xlate_hash);
EXPORT_SYMBOL(_bcm_fb_l2_to_l2x);
EXPORT_SYMBOL(soc_mem_parity_restore);
EXPORT_SYMBOL(_soc_mem_cmp_l3x_set);
EXPORT_SYMBOL(soc_reg_field_length);
EXPORT_SYMBOL(soc_tr_mpls_hash);
EXPORT_SYMBOL(mbcm_init);
EXPORT_SYMBOL(soc_tr_vlan_xlate_base_entry_to_key);
EXPORT_SYMBOL(soc_pci_test);
EXPORT_SYMBOL(soc_tr_egr_vlan_xlate_hash);
EXPORT_SYMBOL(soc_mem_test);
EXPORT_SYMBOL(soc_fb_l2x_lookup);
EXPORT_SYMBOL(soc_ser_test_mem);
EXPORT_SYMBOL(soc_reg_datamask);
EXPORT_SYMBOL(soc_ser_test);
EXPORT_SYMBOL(soc_cm_config_var_get);
EXPORT_SYMBOL(soc_tr_mpls_bank_entry_hash);
EXPORT_SYMBOL(soc_reg_above_64_datamask);
EXPORT_SYMBOL(_shr_div32r);
EXPORT_SYMBOL(soc_mem_cpu_write_control);
EXPORT_SYMBOL(soc_draco_l2x_base_entry_to_key);
EXPORT_SYMBOL(soc_dma_rld_desc_add);
EXPORT_SYMBOL(soc_reg_field32_modify);
EXPORT_SYMBOL(shr_bitop_range_or);
EXPORT_SYMBOL(soc_reg64_datamask);
EXPORT_SYMBOL(soc_tr_egr_vlan_xlate_bank_entry_hash);
EXPORT_SYMBOL(soc_mem_parity_control);
EXPORT_SYMBOL(soc_counter_set32);
EXPORT_SYMBOL(soc_fb_l2x_insert);
EXPORT_SYMBOL(soc_counter_status);
EXPORT_SYMBOL(soc_pci_analyzer_trigger);
#include <soc/firebolt.h>
EXPORT_SYMBOL(soc_xgs3_port_to_higig_bitmap);
EXPORT_SYMBOL(soc_dma_dv_join);
EXPORT_SYMBOL(soc_mem_forcedata_get);
EXPORT_SYMBOL(soc_fb_l2x_delete);
EXPORT_SYMBOL(soc_dma_abort);

EXPORT_SYMBOL(soc_gen_entry_from_key);
EXPORT_SYMBOL(soc_cmicm_intr0_disable);
EXPORT_SYMBOL(_soc_triumph3_mem_parity_control);
EXPORT_SYMBOL(soc_trident2_ser_set_long_delay);
EXPORT_SYMBOL(soc_host_ccm_copy);

EXPORT_SYMBOL(inspur_xe_sfp_tx_enable);
EXPORT_SYMBOL(inspur_xe_sfp_tx_disable);
EXPORT_SYMBOL(inspur_set_xe_port_sfp_tx);
