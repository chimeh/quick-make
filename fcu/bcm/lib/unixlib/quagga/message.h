...
#ifndef _ZEBOS_MESSAGE_H
#define _ZEBOS_MESSAGE_H
...
struct message_handler *message_server_create (ms_zg_t *);
...
struct message_handler *message_client_create (ms_zg_t *, int);
...
void message_client_disconnect (struct message_handler *, int);
...
void message_queue_init (ms_zg_t *, struct message_queue *);
struct message_queue_entry *message_queue_top (struct message_queue *);
void message_queue_clear (struct message_queue *);
void message_queue_entry_set (struct message_queue *, int,
                              u_char *, u_int32_t, u_int32_t);

#endif /* _ZEBOS_MESSAGE_H */
