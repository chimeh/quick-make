...
struct list *link_list_init(struct list  *list, 
		       list_cmp_cb_t cmp, 
		       list_del_cb_t del)
{
  return list_init(list, cmp, del);
}
...
/* ospf_spf.c */
void
list_add_node_prev (struct list *list, struct listnode *curnode, void *val)
{
  struct listnode *node;
...
/* ospf_spf.c */
void
list_add_node_next (struct list *list, struct listnode *curnode, void *val)
{
  struct listnode *node;
