...
#define HSL_TRACE_GEN(S)                      HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ADMIN,"%s",S)

/* System operations */  
#define HSL_ERR_SYS_DETECTION(E)              HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) System Detection failed error code",__FILE__,__LINE__,E); 
#define HSL_ERR_UNSUPPORTED_DEV(D)            HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error: Unsupported System dev id: %d",__FILE__,__LINE__,D); 
#define HSL_ERR_SYS_INIT_FAILED(E)            HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) System Init failed",__FILE__,__LINE__,E);
#define HSL_ERR_BRIDGE_INIT_FAILED(E)         HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Bridge Init failed",__FILE__,__LINE__,E);
#define HSL_ERR_RESET_FAILED(E)               HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Reseting the system",__FILE__,__LINE__,E); 
...
/* OS related */
#define HSL_ERR_MUTEX_CREATE(S)               HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error (%d) to create mutex descriptors!",__FILE__,__LINE__,S);
#define HSL_ERR_SEM_CREATE(S)                 HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error (%d) to create semaphore!",__FILE__,__LINE__,S);
#define HSL_ERR_MALLOC(D)                     HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error Memory allocation failed size:(%d)!",__FILE__,__LINE__,D);
#define HSL_ERR_DMA_MALLOC(D)                 HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error DMA memory allocation failed size:(%d)!",__FILE__,__LINE__,D);
#define HSL_ERR_THREAD_CREATE(E)              HSL_LOG (HSL_LOG_PLATFORM, HSL_LEVEL_FATAL,"%s:%d Error(%d)start thread\n",E);


/* Bridge related */
#define HSL_ERR_BRIDGE_NOT_FOUND(S)           HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error: Bridge (%s) not found",__FILE__,__LINE__,S)
#define HSL_ERR_SET_L2_TIMEOUT(E,T)           HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Setting L2 aging timeout to: %d sec",__FILE__,__LINE__,E,T);
...
/* Router related. */
#define HSL_ERR_ENABLE_VR(E)                  HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error: (%d) Failed to enable virtual router",__FILE__,__LINE__,E);

/* Multicast  related. */
#define HSL_ERR_INSTALL_MCAST_FLT(E)          HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error: (%d)Failed to install default mcast group and filter",__FILE__,__LINE__,E);
#define HSL_ERR_ENABLE_MCAST_FLT_ON_PORT(E,P) HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error: (%d) Failed to enable default mcast filter on  port (%d)",__FILE__,__LINE__,E,P);
...
/* Vlan related */ 
#define HSL_ERR_VID_CREATION_FAILED(E,V,S)    HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Empty vlan: %d creation for STG: %d",__FILE__,__LINE__,E,V,S);
#define HSL_ERR_SET_DEF_VLAN_FAILED(E,V,P)    HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Set default vid: %d for lport: %d",__FILE__,__LINE__,E,V,P);
#define HSL_ERR_DEL_VL_FROM_PRT_FAILED(E,V,P) HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Del vlan: %d from port: %d",__FILE__,__LINE__,E,V,P); 
#define HSL_ERR_ADD_VL_TO_PRT_FAILED(E,V,P)   HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Add vlan: %d to port: %d",__FILE__,__LINE__,E,V,P); 
#define HSL_ERR_ADD_VL_TO_BRG_FAILED(E,V,B)   HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Add vlan: %d to bridge %s",__FILE__,__LINE__,E,V,B);
#define HSL_ERR_BIND_VID_STG_FAILED(E,V,S)    HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Bind vlan: %d to STG: %d",__FILE__,__LINE__,E,V,S);
#define HSL_ERR_UNBIND_VID_STG_FAILED(E,V)    HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Unbind vlan: %d",__FILE__,__LINE__,E,V);
...
#define HSL_ERR_ADD_L2_ENTRY(E,M,V)               HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Add mac %x:%x:%x:%x:%x:%x to vid %d ",__FILE__,__LINE__,E,M[0],M[1],M[2],M[3],M[4],M[5],V);
#define HSL_ERR_DEL_L2_ENTRY(E,M,V)               HSL_LOG(HSL_LOG_COMMON,HSL_LEVEL_ERROR,"%s:%d Error:(%d) Delete mac %x:%x:%x:%x:%x:%x from vid %d",__FILE__,__LINE__,E,M[0],M[1],M[2],M[3],M[4],M[5],V);
