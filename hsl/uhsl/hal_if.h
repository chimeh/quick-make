...
{
  u_int64_t ucastpkts;
  u_int64_t ucastbytes;
  u_int64_t mcastpkts;
  u_int64_t mcastbytes;
  u_int32_t  vlan_id;
};
...
{
  u_int64_t hostInpkts;
  u_int64_t hostOutpkts;
  u_int64_t hostOuterrs;
  u_int64_t learnDrops;
};
...
struct hal_if_counters
  {
    u_int64_t out_errors;
    u_int64_t out_discards;
    u_int64_t out_mc_pkts;
    u_int64_t out_uc_pkts;
    u_int64_t in_discards;
    u_int64_t good_octets_rcv;
    u_int64_t bad_octets_rcv;
    u_int64_t mac_transmit_err;
    u_int64_t good_pkts_rcv;
    u_int64_t bad_pkts_rcv;
    u_int64_t brdc_pkts_rcv;
    u_int64_t mc_pkts_rcv;
    u_int64_t pkts_64_octets_rcv;
    u_int64_t pkts_65_127_octets_rcv;
    u_int64_t pkts_128_255_octets_rcv;
    u_int64_t pkts_256_511_octets_rcv;
    u_int64_t pkts_512_1023_octets_rcv;
    u_int64_t pkts_1024_1518_octets_rcv;
    u_int64_t good_octets_sent;
    u_int64_t good_pkts_sent;
    u_int64_t excessive_collisions;
    u_int64_t mc_pkts_sent;
    u_int64_t brdc_pkts_sent;
    u_int64_t unrecog_mac_cntr_rcv;
    u_int64_t fc_sent;
    u_int64_t good_fc_rcv;
    u_int64_t drop_events;
    u_int64_t undersize_pkts;
    u_int64_t fragments_pkts;
    u_int64_t oversize_pkts;
    u_int64_t jabber_pkts;
    u_int64_t mac_rcv_error;
    u_int64_t bad_crc;
    u_int64_t collisions;
    u_int64_t late_collisions;
    u_int64_t bad_fc_rcv;
    u_int64_t port_in_overflow_frames;
    u_int64_t port_out_overflow_frames;
    u_int64_t port_in_overflow_discards;
    u_int64_t in_filtered;
    u_int64_t out_filtered;
    u_int64_t mtu_exceed;
  };

struct hal_vlan_if_counters
{
  u_int64_t next_free_local_vlan_index;
  u_int64_t tp_vlan_port_in_frames;
  u_int64_t tp_vlan_port_out_frames;
  u_int64_t tp_vlan_port_in_discards;
  u_int64_t tp_vlan_port_in_overflow_frames;
  u_int64_t tp_vlan_port_out_overflow_frames;
  u_int64_t tp_vlan_port_in_overflow_discards;
  u_int64_t tp_vlan_port_HC_in_frames;
  u_int64_t tp_vlan_port_HC_out_frames;
  u_int64_t tp_vlan_port_HC_in_discards;
 };
