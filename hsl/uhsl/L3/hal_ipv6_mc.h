...
#ifndef _HAL_IPV6_MC_H_
#define _HAL_IPV6_MC_H_
...
*/
int
hal_ipv6_mc_set_max_rate_limit (unsigned int index, unsigned int rate_limit);
...
*/
int
hal_ipv6_mc_get_max_rate_limit (unsigned int index, unsigned int rate_limit);
