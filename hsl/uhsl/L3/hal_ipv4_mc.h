...
#ifndef _HAL_IPV4_MC_H_
#define _HAL_IPV4_MC_H_
...
*/
int
hal_ipv4_mc_set_max_rate_limit (unsigned int index, unsigned int rate_limit);
...
*/
int
hal_ipv4_mc_get_max_rate_limit (unsigned int index, unsigned int rate_limit);
...
*/
int
hal_ipv4_mc_delete_mfc (struct hal_in4_addr *source,
