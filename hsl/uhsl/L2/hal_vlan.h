...
int
hal_vlan_disable (char *bridge_name, enum hal_vlan_type type,
                  unsigned short vid);

int
hal_vlan_enable (char *bridge_name, enum hal_vlan_type type,
                 unsigned short vid);
...
*/
int
hal_vlan_add (char *name, enum hal_vlan_type type, enum hal_evc_type evc_type,
              unsigned short vid);

int
hal_uni_add (char *name, unsigned int port_no, u_char uni_type,
             u_int16_t svid);
/* 
...
/*
   ...
   HAL_SUCCESS
*/
int hal_l2_unknown_mcast_mode (int);
...
int
hal_vlan_create_cvlan (char *name, unsigned short cvid, unsigned short svid);
...
int
hal_vlan_delete_cvlan (char *name, unsigned short cvid, unsigned short svid);
