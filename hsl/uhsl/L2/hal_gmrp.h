/* Copyright (C) 2005-2011 IP Infusion, Inc. All Rights Reserved. */
...
int
hal_l2_gmrp_set_service_requirement (char *bridge_name, int vlanid,
                                     int ifindex, int serv_req,
                                     hal_bool_t activate);
...
extern int hal_gmrp_set_bridge_ext_filter (char *name, hal_bool_t enable);
