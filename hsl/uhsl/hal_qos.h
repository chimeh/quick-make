...
#define HAL_QOS_IF_QUEUE_WEIGHT_DEFAULT (100/8)
#define HAL_QOS_IF_WEIGHT_DEFAULT       100
#define HAL_QOS_NUM_QUEUES_DEFAULT      8
...
#define HAL_QOS_DSCP_MAP_ALL_PORTS     -1
...
int hal_qos_set_global_dscp_mapping (struct hal_dscp_map_table *map_table,
                                     int count);
int hal_qos_unset_global_dscp_mapping (struct hal_dscp_map_table *map_table,
                                       int count);
