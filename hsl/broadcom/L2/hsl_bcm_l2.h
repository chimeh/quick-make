...
#define HSL_BCM_STG_MAX_INSTANCES                17
...
int hsl_bcm_set_if_mac_learning (struct hsl_if *ifp, int disable);
...
int hsl_bcm_set_vlan_port_type (struct hsl_bridge *b, struct hsl_bridge_port *port, enum hal_vlan_port_type port_type, enum hal_vlan_acceptable_frame_type acceptable_frame_types, u_int16_t enable_ingress_filter);
...
int hsl_bcm_vlan_stacking_disable (u_int32_t ifindex);
int hsl_bcm_vlan_stacking_ether_set (u_int32_t ifindex, u_int16_t tpid);
