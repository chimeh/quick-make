                        ...
                        int vlan, int cos)
{
  ...
  hsl_bcm_set_cpudb_properties (0, mac/* KEY */, mac, base_dest_port, 0/* flags */,
  ...
  {  
      hsl_bcm_add_stack_port (0, port_struct->unit[ii], port_struct->port[ii],
          ...
          -1 /* Tx stack IDX */, -1 /* Rx stack IDX */, mac, (char*)&(tx_cpu_key.key),
          (char*)&(rx_cpu_key.key));
  }
 
  hsl_bcm_set_modid (0, mac, -1 /* Mod ID*/, pref_mod_id, mod_ids_req);

  hsl_bcm_set_local_key (0, mac);
