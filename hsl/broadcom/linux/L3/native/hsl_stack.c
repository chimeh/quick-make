...
#if 0   /* NETFORD :NOTICE: inet_protocol -> net_protocol in 2.6 ..
            pim_protocol is declared in linux/net/ipv4/ipmr.c */
...
hsl_os_if_init (void)
{
  ...
  hsl_ifmgr_set_flags(NULL, dev->ifindex, dev->flags|IFF_UP);
