...
*/
int
hsl_vlan_add (char *name, hsl_vid_t vid)
{
  struct hsl_vlan_port *v = NULL;
			...
			u_int16_t enable_ingress_filter)
{
  ...
  if (p_hsl_bridge_master->hw_cb && p_hsl_bridge_master->hw_cb->set_vlan_port_type)
    (*p_hsl_bridge_master->hw_cb->set_vlan_port_type) (p_hsl_bridge_master->bridge, port, port_type, acceptable_frame_types, enable_ingress_filter);
