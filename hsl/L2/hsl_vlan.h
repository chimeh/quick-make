...
int hsl_vlan_port_set_port_type (char *name, hsl_ifIndex_t ifindex, enum hal_vlan_port_type port_type, enum hal_vlan_acceptable_frame_type acceptable_frame_types,   u_int16_t enable_ingress_filter);
...
int hsl_vlan_set_port_type (char *name, hsl_ifIndex_t ifindex, enum hal_vlan_port_type port_type, enum hal_vlan_acceptable_frame_type acceptable_frame_types, u_int16_t enable_ingress_filter);
