...
#define HSL_MSG_PROCESS_RETURN_WITH_VALUE(SOCK,HDR,RET)                                                       \
       do {                                                                                        \
            if ((HDR)->nlmsg_flags & HAL_NLM_F_ACK)                                                \
              {                                                                                    \
                if ((RET) < 0)                                                                     \
...
int hsl_msg_recv_debug_hsl (struct socket *sock, struct hal_nlmsghdr *hdr, char *msgbuf);
...
int hsl_msg_recv_lacp_global_psc_set (struct socket *, struct hal_nlmsghdr *hdr, char *msgbuf);
...
int hsl_msg_recv_fwdu_ufib4_add(struct socket *, struct hal_nlmsghdr *hdr, char *msgbuf);
int hsl_msg_recv_fwdu_ufib4_del(struct socket *, struct hal_nlmsghdr *hdr, char *msgbuf);
int hsl_msg_recv_fwdu_nbr_add(struct socket *, struct hal_nlmsghdr *hdr, char *msgbuf);
int hsl_msg_recv_fwdu_nbr_del(struct socket *, struct hal_nlmsghdr *hdr, char *msgbuf);
