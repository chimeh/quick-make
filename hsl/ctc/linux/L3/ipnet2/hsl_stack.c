...
#else
#define IPNET_IF_INDEXTONETIF(index)  ipnet_if_indextonetif(0, (index))
#endif
				   ...
				   int add)
{
  ...
  if (IP_IN6_IS_ADDR_LINK_LOCAL(&in_addr->sin6_addr))
...

{
  ...
  /* Copy interface name. */
  ipcom_if_indextoname(ifp->ifindex, req.ifr_name);
    ...
    int event, void *data)
{
   ...
   */
  if (!IP_IN6_IS_ADDR_LINK_LOCAL ((struct Ip_in6_addr *)data))
    return ret;
...
hsl_if_os_cb_register (void)
{
  ...
  hsl_linux_ipnet_if_os_callbacks.os_l3_if_flags_set = hsl_os_l3_if_flags_set;
  hsl_linux_ipnet_if_os_callbacks.os_l3_if_flags_unset = hsl_os_l3_if_flags_unset;
...
hsl_os_ipv4_mc_pim_init ()
{
  ...
  IPNET_CODE_LOCK ();
  ipnet_ip4_mcast_set_assert(NULL,IP_TRUE);
  IPNET_CODE_UNLOCK ();
...
hsl_os_ipv4_mc_pim_deinit ()
{
  ...
  IPNET_CODE_LOCK ();
  ipnet_ip4_mcast_set_assert(NULL,IP_FALSE);
  IPNET_CODE_UNLOCK ();
			  ...
			  u_char *olist_ttls)
{
  ...
  IPNET_CODE_LOCK ();
  ret = ipnet_ip4_mcast_add_mfc (NULL,&mfc);
  IPNET_CODE_UNLOCK ();
...
hsl_os_ipv4_mc_route_del (hsl_ipv4Address_t src,hsl_ipv4Address_t group)
{
  ...
  IPNET_CODE_LOCK ();
  ret = ipnet_ip4_mcast_del_mfc (NULL,&mfc);
  IPNET_CODE_UNLOCK ();
...
#else
  ret = ipnet_ip4_mcast_add_vif (NULL, &vif);
#endif
  IPNET_CODE_UNLOCK ();
...
hsl_os_ipv4_mc_vif_del (u_int32_t vif_index)
{
  ...
  IPNET_CODE_LOCK ();
  ret = ipnet_ip4_mcast_del_vif (NULL,(Ip_vifi_t) vif_index);
  IPNET_CODE_UNLOCK ();
...
hsl_os_ipv6_mc_pim_init ()
{
  ...
  IPNET_CODE_LOCK ();
  ipnet_ip6_mcast_set_pim (NULL,1);
  IPNET_CODE_UNLOCK ();
...
hsl_os_ipv6_mc_pim_deinit ()
{
  ...
  IPNET_CODE_LOCK ();
  ipnet_ip6_mcast_set_pim (NULL,0);
  IPNET_CODE_UNLOCK ();
			  ...
			  u_int16_t *olist)
{
  ...
  IPNET_CODE_LOCK ();
  ret = ipnet_ip6_mcast_add_mfc (NULL,&mfc);
  IPNET_CODE_UNLOCK ();
...
hsl_os_ipv6_mc_route_del (hsl_ipv6Address_t *src,hsl_ipv6Address_t *group)
{
  ...
  IPNET_CODE_LOCK ();
  ret = ipnet_ip6_mcast_del_mfc (NULL,&mfc);
  IPNET_CODE_UNLOCK ();
...
#else
  ret = ipnet_ip6_mcast_del_mif (NULL,(Ip_mifi_t) mif_index);
#endif
